...
import Game.Shields.HeavyShield;
import Game.Shields.LightShield;
import Game.Warriors.Archer;
import Game.Warriors.Footman;
import Game.Warriors.Warrior;
import Game.Weapon.MeleeWeapon;
import Game.Weapon.RangedWeapon;

public class Main {
    public static void main(String[] args) {
        Team<Footman<Game.Shields.Shield>> footSquad = new Team<>("Пехота");
        ...
        Team<Warrior> mixedSquad = new Team<>("Сборная");
    ...
    private static void makeBattle(Team<Archer> team1, Team team2) {
